...
const BlogCard = ({ blog, onClick }) => {
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -8 }}
      onClick={onClick}
      className="bg-gray-900/50 backdrop-blur-sm rounded-[14px] border border-gray-800 shadow-[0_2px_20px_rgba(0,0,0,0.3)] overflow-hidden transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_12px_40px_rgba(16,185,129,0.2)] cursor-pointer group"
    >
      {/* Image Container */}
      <div className="relative aspect-video overflow-hidden">
        ...
        {/* Date Badge */}
        <div className="absolute top-3 right-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white w-12 h-12 rounded-full flex flex-col items-center justify-center font-bold shadow-lg">
          <span className="text-sm leading-none">{day}</span>
          <span className="text-[10px] leading-none opacity-80">{month}</span>
        </div>

        {/* Category Badge */}
        <div className="absolute top-3 left-3 bg-emerald-500/90 backdrop-blur-sm text-white px-3 py-1 text-[11px] font-black uppercase tracking-widest rounded-full">
      ...
      <div className="p-6">
        ...
        <h3 className="font-bold text-xl text-white mb-3 leading-tight group-hover:text-emerald-400 transition-colors">
          {blog.title}
        </h3>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {blog.tags.length > 3 && (
            <span className="px-3 py-1 bg-gray-800/50 border border-gray-700 text-gray-400 text-xs rounded-full">
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 text-center">
            ...
            >
              ...
              >
                ...
                <span className="text-emerald-400 text-sm font-semibold">AI Research</span>
              </motion.div>

              {/* Main Title */}
              <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-emerald-400 to-green-400 bg-clip-text text-transparent">
                Research
              ...
              >
                {researchData[0].keywords.map((keyword, idx) => (
                  <motion.span
                    ...
                    className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:bg-emerald-500/10 hover:border-emerald-500/30 hover:text-emerald-400 transition-all duration-300"
                  >
                    {keyword}
                  </motion.span>
                ))}
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-emerald-400 mb-2">10/10</div>
        ...
        <section className="relative py-24 bg-gradient-to-b from-transparent via-gray-900/50 to-black">
          <div className="max-w-7xl mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold text-white">Featured Blog</h2>
              </div>
            ...
            >
              <button className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-500 to-green-500 text-white font-semibold rounded-full hover:from-emerald-600 hover:to-green-600 transition-all duration-300 shadow-lg hover:shadow-emerald-500/25">
                View All Blog Posts
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white w-12 h-12 rounded-full flex flex-col items-center justify-center font-bold shadow-lg">
                    ...
                    <span className="text-[10px] leading-none opacity-80">MAY</span>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="text-gray-300 text-sm leading-relaxed mb-4 space-y-3">
                  ...
                  {/* Tags */}
                  <div className="flex flex-wrap gap-2 mb-6">
                    <span className="px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs rounded-full hover:bg-emerald-500/20 transition-colors">
                      career development
                    </span>
                    <span className="px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs rounded-full hover:bg-emerald-500/20 transition-colors">
                      future skills
